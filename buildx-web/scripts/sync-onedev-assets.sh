...
cp "$ONEDEV_WEB/page/project/blob/render/edit/blob-edit.css" "$PUBLIC/onedev/css/"
cp "$ONEDEV_WEB/page/project/blob/render/renderers/buildspec/build-spec.css" "$PUBLIC/onedev/css/"
