...
export default function DefaultFixedIssueFiltersPage() {
  ...
  return (
    <ProjectLayout projectPath={projectPath} pageTitle="Default Fixed Issue Filters">
              ...
              <nav className="nav flex-column">
                {SETTINGS_NAV.map((item) => (
                  <Link
                    key={item.href}
                    to={item.href}
                    className={`nav-link ${item.label === "Default Fixed Issue Filters" ? "active" : ""}`}
                  >
                    {item.label}
                  </Link>
                ))}
        ...
        <div className="flex-grow-1">
          <div className="card card-custom">
            <div className="card-header">
              <h5 className="card-title mb-0">Default Fixed Issue Filters</h5>
            </div>
            <div className="card-body">
