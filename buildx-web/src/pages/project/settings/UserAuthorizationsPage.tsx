...
export default function UserAuthorizationsPage() {
  ...
  return (
    <ProjectLayout projectPath={projectPath} pageTitle="User Authorizations">
              ...
              <nav className="nav flex-column">
                {SETTINGS_NAV.map((item) => (
                  <Link
                    key={item.href}
                    to={item.href}
                    className={`nav-link ${item.label === "User Authorizations" ? "active" : ""}`}
                  >
                    {item.label}
                  </Link>
                ))}
        ...
        <div className="flex-grow-1">
          <div className="card card-custom">
            <div className="card-header d-flex justify-content-between align-items-center">
              <h5 className="card-title mb-0">User Authorizations</h5>
